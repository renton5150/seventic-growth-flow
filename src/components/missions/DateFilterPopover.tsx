...
export function DateFilterPopover({ hasFilter, onFilterChange, onClearFilter, currentFilter }: DateFilterPopoverProps) {
  ...
  const filterLabel = formatSelectedFilter();
      ...
      <PopoverContent className="w-auto p-4 min-w-[300px]" align="end">
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h4 className="font-medium">Filtre de date</h4>
            {hasFilter && (
              <Button 
                variant="ghost" 
                size="sm" 
